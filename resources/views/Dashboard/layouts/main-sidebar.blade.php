...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/dashboard') }}"><h2>Invoices App</h2></a>
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">Invoices App</li>
            <li class="slide">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . $page='paidInvoices') }}">Paid Invoices</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='nonPaidInvoices') }}">Non paid invoices</a></li>
                    <li><a class="slide-item" href="{{ url('/' . $page='partialPaidInvoices') }}">Partial paid
                            invoices</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . $page='section') }}">Sections</a></li>
